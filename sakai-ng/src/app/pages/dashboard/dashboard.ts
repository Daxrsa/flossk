...
@Component({
    ...
    imports: [CommonModule, FormsModule, TableModule, ButtonModule, TagModule, DialogModule, DividerModule, InputTextModule, TextareaModule, PanelModule, ConfirmDialogModule, SkeletonModule],
    ...
    template: `   
        ...
        <p-dialog [(visible)]="viewDialogVisible" [header]="selectedRequest ? selectedRequest.fullName : 'Request Details'" [modal]="true" [style]="{width: '50rem'}" appendTo="body">
            <div *ngIf="selectedRequest" class="flex flex-col gap-4">
                ...
                <ng-container *ngIf="selectedRequest?.status?.toLowerCase() === 'pending'">
...
export class Dashboard implements OnInit {
    ...
    private checkLoadingComplete() {
        if (this.padsLoaded && this.requestsLoaded) {
