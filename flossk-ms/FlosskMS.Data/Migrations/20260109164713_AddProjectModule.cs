    ...
    public partial class AddProjectModule : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObjectiveTeamMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ObjectiveTeamMembers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ObjectiveTeamMembers_Objectives_ObjectiveId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resources_Objectives_ObjectiveId",
                        column: x => x.ObjectiveId,
                        principalTable: "Objectives",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ObjectiveTeamMembers_ObjectiveId_UserId",
                table: "ObjectiveTeamMembers",
                columns: new[] { "ObjectiveId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ObjectiveTeamMembers_UserId",
                table: "ObjectiveTeamMembers",
                column: "UserId");
